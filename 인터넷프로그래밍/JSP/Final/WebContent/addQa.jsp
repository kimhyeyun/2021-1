...
<link rel="stylesheet" href="css/writerqa.css">
</head>
<body>
	<%
	String userid = null;
	...
	<div class="wrap">
		...
		<div class="container">
			...
			<div class="contents">
				...
				<div>
					<form method="post" action="qaAdd" name="dto">
						<div class="table">
							<table>
								<tbody>
									<tr>
										<th scope="row">제목</th>
										<td><input class="in" type="text" name="qtitle" required="required"></td>
									</tr>
									<tr>
										<th scope="row">작성자</th>
										<td><input class="in" type="text" value=<%= userid %> name="userid" readonly="readonly"></td>
									</tr>
									<tr>
										<td colspan="2">
											<div>
												<textarea style="width: 100%;" name="qcontent"required="required"></textarea>
											</div>
										</td>
									</tr>
								</tbody>
