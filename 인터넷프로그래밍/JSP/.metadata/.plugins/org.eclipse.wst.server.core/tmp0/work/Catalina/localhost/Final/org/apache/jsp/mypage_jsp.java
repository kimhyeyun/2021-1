 ...
 * Generated at: 2021-06-12 15:37:18 UTC
...
public final class mypage_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	if(session.getAttribute("userid") != null){
      ...
      out.write("\n");
      out.write("<script>\n");
      out.write("function userDelete(userid){\n");
      out.write("\tif(confirm(\"정말 탈퇴하시겠습니까?\")){\n");
      out.write("\t\tlocation.href = \"userInfoDelete\";\n");
      out.write("\t}\n");
      out.write("}\n");
      out.write("</script>\n");
      out.write("\n");
      ...
      out.write("\t\t\t\t</div>\n");
      out.write("\n");
      out.write("\t\t\t\t<form id=\"myform\" method=\"post\" action=\"userInfoUpdate\"\n");
      out.write("\t\t\t\t\tname=\"userinfo\">\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t<td><input id=\"userID\" name=\"userid\" type=\"text\"\n");
      out.write("\t\t\t\t\t\t\t\t\t\tvalue=");
      out.print(userid);
      ...
      out.write("\t\t\t\t\t\t\t\t\t<td><input id=\"userPW\" name=\"userpw\" type=\"password\" required=\"required\"></td>\n");
      out.write("\t\t\t\t\t\t\t\t</tr>\n");
      out.write("\t\t\t\t\t\t\t\t<tr>\n");
      out.write("\t\t\t\t\t\t\t\t\t<th scope=\"row\">이름</th>\n");
      out.write("\t\t\t\t\t\t\t\t\t<td><input id=\"userName\" name=\"username\" type=\"text\" required=\"required\"></td>\n");
      out.write("\t\t\t\t\t\t\t\t</tr>\n");
      out.write("\t\t\t\t\t\t\t\t<tr>\n");
      out.write("\t\t\t\t\t\t\t\t\t<th scope=\"row\">전화번호</th>\n");
      out.write("\t\t\t\t\t\t\t\t\t<td><input id=\"userPhone\" name=\"userphone\" type=\"tel\" required=\"required\"></td>\n");
      out.write("\t\t\t\t\t\t\t\t</tr>\n");
      out.write("\t\t\t\t\t\t\t</tbody>\n");
      out.write("\t\t\t\t\t\t</table>\n");
      out.write("\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t<div id=\"infosub\">\n");
      out.write("\t\t\t\t\t\t<input type=\"submit\" value=\"정보수정\" class=\"btnmy\"> \n");
      out.write("\t\t\t\t\t\t<a onclick=\"userDelete('");
      out.print(userid);
      out.write("')\" id=\"delbtn\" style=\"cursor:pointer\">회원탈퇴</a>\n");
      out.write("\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t</form>\n");
      out.write("\t\t\t</div>\n");
      out.write("\n");
