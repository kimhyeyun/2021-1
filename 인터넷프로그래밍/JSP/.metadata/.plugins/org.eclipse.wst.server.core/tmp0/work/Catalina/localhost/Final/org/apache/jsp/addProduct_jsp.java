 ...
 * Generated at: 2021-06-12 15:18:26 UTC
...
public final class addProduct_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("<link rel=\"stylesheet\" href=\"css/addprod.css\">\n");
      out.write("</head>\n");
      out.write("<body>\n");
      out.write("\t");
	...
	if(session.getAttribute("userid") != null){
      ...
      out.write("\n");
      out.write("\t\t\t\t<div>\n");
      out.write("\t\t\t\t\t<form method=\"post\" action=\"productAdd\" id=\"addprodform\" name=\"dto\">\n");
      out.write("\t\t\t\t\t\t<div class=\"table\">\n");
      out.write("\t\t\t\t\t\t\t<table>\n");
      out.write("\t\t\t\t\t\t\t\t<tbody>\n");
      out.write("\t\t\t\t\t\t\t\t\t<tr>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<th scope=\"row\">카테고리</th>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td><select name=\"pcode\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<option value=\"1\">IPHONE</option>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<option value=\"2\">AIRPODS</option>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<option value=\"3\">SMART TOK</option>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<option value=\"4\">KEYRING</option>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</select>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</td>\n");
      out.write("\t\t\t\t\t\t\t\t\t</tr>\n");
      out.write("\t\t\t\t\t\t\t\t\t<tr>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<th scope=\"row\">상품명</th>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td><input class=\"in\" type=\"text\" name=\"pname\" required=\"required\"></td>\n");
      out.write("\t\t\t\t\t\t\t\t\t</tr>\n");
      out.write("\t\t\t\t\t\t\t\t\t<tr>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<th scope=\"row\">상품금액</th>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td><input class=\"in\" type=\"number\" name=\"pprice\" required=\"required\"></td>\n");
      out.write("\t\t\t\t\t\t\t\t\t</tr>\n");
      out.write("\t\t\t\t\t\t\t\t\t<tr>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<th scope=\"row\">이미지 URL</th>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td><input class=\"in\" type=\"text\" name=\"pimage\" required=\"required\"></td>\n");
      out.write("\t\t\t\t\t\t\t\t\t</tr>\n");
      out.write("\t\t\t\t\t\t\t\t\t<tr>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td colspan=\"2\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<textarea style=\"width: 100%;\" name=\"pcontent\"required=\"required\"></textarea>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</td>\n");
      out.write("\t\t\t\t\t\t\t\t\t</tr>\n");
      out.write("\t\t\t\t\t\t\t\t</tbody>\n");
      ...
      out.write("\t\t\t\t\t\t</div>\n");
      out.write("\n");
      out.write("\t\t\t\t\t\t<input type=\"submit\" value=\"등록\" id=\"subbtn\">\n");
      out.write("\t\t\t\t\t</form>\n");
      out.write("\t\t\t\t</div>\n");
      out.write("\n");
      out.write("\n");
