 ...
 * Generated at: 2021-06-12 15:34:14 UTC
...
public final class addQa_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("<title>WRITE Q&A</title>\n");
      out.write("\n");
      out.write("<link rel=\"stylesheet\" href=\"css/menu.css\">\n");
      out.write("<link rel=\"stylesheet\" href=\"css/writerqa.css\">\n");
      out.write("</head>\n");
      out.write("<body>\n");
      out.write("\t");
	...
	if(session.getAttribute("userid") != null){
      ...
      out.write("\t\t\t\t\t<h2>WRITE Q&A</h2>\n");
      out.write("\t\t\t\t</div>\n");
      out.write("\n");
      out.write("\t\t\t\t<div>\n");
      out.write("\t\t\t\t\t<form method=\"post\" action=\"qaAdd\" name=\"dto\">\n");
      out.write("\t\t\t\t\t\t<div class=\"table\">\n");
      out.write("\t\t\t\t\t\t\t<table>\n");
      out.write("\t\t\t\t\t\t\t\t<tbody>\n");
      out.write("\t\t\t\t\t\t\t\t\t<tr>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<th scope=\"row\">제목</th>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td><input class=\"in\" type=\"text\" name=\"qtitle\" required=\"required\"></td>\n");
      out.write("\t\t\t\t\t\t\t\t\t</tr>\n");
      out.write("\t\t\t\t\t\t\t\t\t<tr>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<th scope=\"row\">작성자</th>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td><input class=\"in\" type=\"text\" value=");
      out.print( userid );
      out.write(" name=\"userid\" readonly=\"readonly\"></td>\n");
      out.write("\t\t\t\t\t\t\t\t\t</tr>\n");
      out.write("\t\t\t\t\t\t\t\t\t<tr>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td colspan=\"2\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<textarea style=\"width: 100%;\" name=\"qcontent\"required=\"required\"></textarea>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</td>\n");
      out.write("\t\t\t\t\t\t\t\t\t</tr>\n");
      out.write("\t\t\t\t\t\t\t\t</tbody>\n");
