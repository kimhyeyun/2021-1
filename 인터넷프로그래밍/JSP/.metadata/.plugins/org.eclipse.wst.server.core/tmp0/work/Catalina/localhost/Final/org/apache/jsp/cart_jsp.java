 ...
 * Generated at: 2021-06-12 14:21:48 UTC
...
public final class cart_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_classes.add("cart.CartDTO");
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	int cnt = dao.totalCnt(userid);
      ...
      out.write("\tfunction cartDelete(pid){\n");
      out.write("\t\tif(confirm(\"정말 삭제하시겠습니까?\"))\n");
      out.write("\t\t\tlocation.href = \"cartDelete?pid=\"+pid;\n");
      out.write("\t}\n");
      out.write("</script>\n");
      out.write("\n");
      out.write("</head>\n");
...
for(int i=0;i<list.size();i++){ 
      ...
      out.write("</td>\n");
      out.write("\t\t\t\t\t\t\t\t\t<td><a onclick=\"cartDelete(");
      out.print(list.get(i).getPid() );
      out.write(")\" id=\"delebtn\">DELETE</a></td>\t\t\t\t\t\t\t\n");
      out.write("\t\t\t\t\t\t\t</tbody>\n");
      out.write("\t\t\t\t\t\t\t");
} 
      out.write("\n");
