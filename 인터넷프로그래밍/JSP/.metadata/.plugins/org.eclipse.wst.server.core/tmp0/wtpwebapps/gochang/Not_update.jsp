...
%>
	...
	<div class="contaniner" style="margin-left: 150px; margin-right: 150px;">
		<div class="row">
			<form method="post" action="Not_update?ntID=<%= ntID %>">
				<table class="table table-striped" style="text-align: center; border: 2px solid royalblue;">
					<thead>
						<tr>
							<th colspan = "2" style="background-color: #eeeeee; text-align: center;">공지 수정</th>
						</tr>
					</thead>
					<tbody>
						<tr>
							<td><input type="text" class="form-control" placeholder ="제목" name="ntTitle" maxlength="50" value="<%= notice.getNtTitle() %>"></td>
						</tr>
						<tr>
							<td><textarea class="form-control" placeholder ="내용" name="ntContent" maxlength="2048" style ="height:350px;"><%= notice.getNtContent() %></textarea></td>
						</tr>
					</tbody>
				</table>
