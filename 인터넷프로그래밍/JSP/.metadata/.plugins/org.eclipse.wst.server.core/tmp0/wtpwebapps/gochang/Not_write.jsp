...
%>
	...
	<div class="contaniner" style="margin-left: 150px; margin-right: 150px;">
		<div class="row">
			<form method="post" action="NotWriteAction.jsp">
				<table class="table table-striped" style="text-align: center; border: 2px solid royalblue;">
					...
					<tbody>
						<tr>
							<td><input type="text" class="form-control" placeholder ="제목" name="ntTitle" maxlength="50"></td>
						</tr>
						<tr>
							<td><textarea class="form-control" placeholder ="내용" name="ntContent" maxlength="2048" style ="height:350px;"></textarea></td>
						</tr>
					</tbody>
				</table>
