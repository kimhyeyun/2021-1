...
<div class="jumbotron">
  <div class="container-fluid">
    <div style="float: left; margin-top: 15px; margin-left: 30px;">
        <img src="./media/dalogo.jpg" style="width:200px">   
    </div>
    ...
    <div style="float: right;">
        <a href="login"><img src="./media/loginI.jpg" style="width:70px;height:70px"></a>
    </div>
    <%
    	} else {
    %>
  ...
  <div class="row">
    <div class="col-sm-4">
      <div class="panel panel-primary">
        <div class="panel-heading">TITAN PC</div>
        <div class="panel-body"><img src="./media/pc1.png" class="img-responsive" style="width:100%" alt="Image"></div>
        <div class="panel-footer">I7-9세대 9700K + RTX 2070 SUPER</div>
      </div>
    </div>
    <div class="col-sm-4"> 
      <div class="panel panel-primary">
        <div class="panel-heading">DYNAMIC PC</div>
        <div class="panel-body"><img src="./media/pc2.png" class="img-responsive" style="width:100%" alt="Image"></div>
        <div class="panel-footer">I7-9세대 9700K + RTX 2070 SUPER</div>
      </div>
    </div>
    <div class="col-sm-4"> 
      <div class="panel panel-primary">
        <div class="panel-heading">EVOLV PC</div>
        <div class="panel-body"><img src="./media/pc3.png" class="img-responsive" style="width:100%" alt="Image"></div>
        <div class="panel-footer">I9-9세대 9900K + RTX 2080 TI</div>
      </div>
    </div>
  </div>
</div><br>
