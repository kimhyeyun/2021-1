	  ...
	  <div class="container-fluid" style="background-color: royalblue;">
	    ...
	    <div class="collapse navbar-collapse" id="myNavbar">
	      <ul class="nav navbar-nav">
	        ...
	        <li class="active"><a href="Mobile.jsp"style="color:white;background-color:blue;">태블릿/모바일</a></li>
	   ...
	   <table class="table table-striped" style="text-align: left; border: 2px solid royalblue;">
	        ...
	        <tbody>
	        	<%
					...
					ArrayList<Goods> list = goodsDAO.getList2(pageNumber);
	    ...
	    <%
			if(pageNumber != 1) {	
		%>
			<a href="Mobile.jsp?pageNumber=<%= pageNumber - 1 %>" class="btn btn-success">이전</a>
		<%
			} if(goodsDAO.nextPage(pageNumber + 1)) {
		%>
			<a href="Mobile.jsp?pageNumber=<%= pageNumber + 1 %>" class="btn btn-success">다음</a>
		<%
			}
		%>
    </div>
